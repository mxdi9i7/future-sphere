const coursesData = [
  {
    ...
    description:
      "软件开发的入门课，学习如何设计、排版一个精致的商业级网站，学习如何使用Git来管理项目的进度以及如何部署这个网站，学习如何在手机、平板、电脑上布局、排版网站。",
    ...
    syllabus: [
      {
        ...
        desc:
          "理解网页是如何编辑而成的，学习并运用各种网页的基础标签来做出一个简单的HTML网页"
      },
      {
        title: "第二课：HTML进阶标签",
        desc:
          "深入学习HTML的其他高级标签，学习如何灵活管理页面上的大量标签，学习如何用HTML做排版设计，学习如何在页面中插入脚本。"
      },
      {
      ...
      },
      {
        title: "第五课：Bootstrap",
        desc:
          "学习如何使用全世界最热门的前端框架：Bootstrap来快速搭建一个网站。以及学习网页的竖版Grid概念。"
      },
      {
      ...
      },
      {
        ...
        desc:
          "学习如何设计一个响应式的网站并使之兼容各大主流浏览器以及手机操作系统的内核，复习往期内容准备期末考试"
      },
      {
        title: "第八课：期末考试",
  ...
  },
  {
    ...
    description:
      "学习时下最热门的JavaScript语言、浏览器元素的操作、以及用户界面交互的功能。探索如何运用JS来编写高效的循环、函数等工作中常见的程序。",
    ...
    syllabus: [
      ...
      },
      {
        title: "第二课：JS运算+常用函数",
        desc:
          "深入学习Javascript的基础用法，包括JS Arithmetic，运用数据进行简单的计算以及运用常见的字符串和数学函数。"
      },
      {
      ...
      },
      {
        ...
        desc:
          "学生可以通过JavaScript来请求某个服务器提供的数据端口以获取JSON数据，并渲染在DOM里。"
      },
      {
        title: "第八课：期末考试",
        desc: "检验学生所学知识，对不熟不懂知识进行再练习"
  ...
  },
  {
    ...
    description:
      "学习服务器的搭建和数据库的设计，以及设计常见、实用的软件后台。学习如何编写、维护、并设计一个大型团队可以分享使用的API文档，以及如何部署你的服务器和数据库。",
    ...
    syllabus: [
      ...
      },
      {
        ...
        desc:
          "了解 NPM/Yarn等包管理工具，并安装一些常用的包。学习如何自己打包一个库并部署到NPM。"
      },
      {
      ...
      },
      {
        ...
        desc:
          "学习如何用POSTMAN来测试你的API并设计部署你的API文档，学习使用Session、JWT来设计你的登录注册功能。"
      },
      {
  ...
  },
  {
    ...
    description:
      "前端工程师必学课程，开发复杂的前端模块化组件，设计数据驱动的软件架构。React是目前就业市场需求最火热的技能，熟练使用React可以让你的年薪轻松突破10万。",
    ...
    syllabus: [
      ...
      },
      {
        title: "第二课：组件和生命周期",
        desc:
          "学习Class component 和Functional Components 的区别，并了解this在二者中的区别。"
      },
      {
      ...
      },
      {
        ...
        desc:
          "学习如何有条件地渲染React Markup以及如何处理网络请求并循环数据结果。"
      },
      {
  ...
  },
  {
    ...
    description:
      "大型商业项目的开发经验、面试的谈资、充实的简历、资深工程师带你Code Review、为学员提供OPT挂靠与项目工作证明、体验小团队创业氛围。",
